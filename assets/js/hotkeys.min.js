!(function (e, t) {
  ...
  function x(e, t, n, o) {
    ...
    if (t.element === o && (t.scope === n || "all" === t.scope)) {
      for (var r in ((i = 0 < t.mods.length), g))
        Object.prototype.hasOwnProperty.call(g, r) &&
          ((!g[r] && ~t.mods.indexOf(+r)) || (g[r] && !~t.mods.indexOf(+r))) &&
          (i = !1);
  ...
  function _(n, e) {
    ...
    if (C.filter.call(this, n)) {
      if (
        ...
        for (var i in ((g[o] = !0), h)) h[i] === o && (C[i] = !0);
        if (!t) return;
      }
      for (var r in g)
      ...
      if (t)
        for (var a = 0; a < t.length; a++)
          t[a].scope === f &&
            (("keydown" === n.type && t[a].keydown) ||
              ("keyup" === n.type && t[a].keyup)) &&
            x(n, t[a], f, e);
      if (o in v)
        for (var c = 0; c < v[o].length; c++)
          if (
            (("keydown" === n.type && v[o][c].keydown) ||
              ("keyup" === n.type && v[o][c].keyup)) &&
            v[o][c].key
          ) {
            for (
              var l = v[o][c], s = l.key.split(l.splitKey), u = [], p = 0;
              p < s.length;
              p++
            )
              u.push(K(s[p]));
      ...
      p(
        ...
        function (e) {
          ...
          if (
            ...
            for (var o in ((g[t] = !1), h)) h[o] === t && (C[o] = !1);
        },
        u
      ));
  }
  ...
  for (i in c) Object.prototype.hasOwnProperty.call(c, i) && (C[i] = c[i]);
  return (
